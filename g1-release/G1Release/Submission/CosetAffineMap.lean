import G1Release.Submission.CosetGroupLaw

namespace G1Release.Submission.CosetAffineMap
...
These algebraic lemmas are ported from codex/test-ci. They do not, on their
own, certify a finite-label ROM submission. At 91 maps, eight byte-aligned
...
theorem eight_table_budget : 91 * 8 * (255 * 32) = 5940480 := by decide

theorem eight_table_above_goal : 4100000 < 91 * 8 * (255 * 32) := by decide

end G1Release.Submission.CosetAffineMap
