...
namespace G1Release.Submission.EisensteinRadix
...
theorem residual_norm_le_bound (scalar count : Nat) (hcount : count ≤ 90) :
  ...
  | zero =>
      ...
      norm_num [BoundaryFacts.scalar_modulus] at h ⊢
      omega
  | succ count ih =>
      rw [residual_succ]
...
end G1Release.Submission.EisensteinRadix
