...
namespace G1Release.Submission.HomogeneousRCBG1GroupLaw
...
private theorem class_formula_affine_of_x_ne
  ...
  have hsum :=
    G1Release.Submission.JacobianAffineAddMap.addMap_of_X_ne (W := BN254.curve)
...
private theorem class_formula_affine_self (point : Affine)
  ...
  have hsum :=
    G1Release.Submission.JacobianAffineAddMap.addMap_of_Y_ne_negY (W := BN254.curve)
      point.x point.y
...
end G1Release.Submission.HomogeneousRCBG1GroupLaw
