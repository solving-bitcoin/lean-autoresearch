import G1Release.Submission.CosetCoordinates
import G1Release.Submission.SamplingEquivalences

namespace G1Release.Submission.CosetFieldSampling
...
ideal finite-coordinate law is uniform without an
...
noncomputable def unitSampleEquiv : UnitSamples ≃ Kˣ :=
  (Equiv.prodCongr directionEquiv Randomized.unitEquiv).trans unitCoordinatesEquiv
...
end G1Release.Submission.CosetFieldSampling
