...
namespace G1Release.Submission.CosetCoordinates
...
These lemmas support the eight-base-field-table construction and its
...
end G1Release.Submission.CosetCoordinates
