...
import G1Release.Submission.G1GeneratorCertificates
...
private theorem scalarFieldModulus_prime : scalarFieldModulus.Prime := by
  simpa [BoundaryFacts.scalar_modulus, _root_.BN254.scalarFieldSize] using
...
end G1Release.Submission.G1Eigenvalue
