import Blake3Prize.Submission.RomROMTrace

namespace Blake3Prize.Submission.RomMeasurable
...
theorem run_variable_measurable {I : Type} [MeasurableSpace I]
  ...
  measurable_from_prod_countable_right fun i => RomROMTrace.run_measurable (program i)
...
theorem hash_variable_measurable {Ω : Type*} [MeasurableSpace Ω]
  ...
  eval_variable_measurable _ (fun q => (RomROMTrace.hash_measurable q).comp ho) query hq

end Blake3Prize.Submission.RomMeasurable
