"""Native end-to-end and hostile framing tests for the optional half-gates baseline."""
import argparse
import sys
...
def main():
    ...
    vector = json.loads((Path(__file__).resolve().parents[2]/'tests/official-vector.json').read_text())
